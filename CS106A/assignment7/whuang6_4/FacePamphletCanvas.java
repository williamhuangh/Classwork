 ...
 */
    private double displayImage(FacePamphletProfile profile,double nameBaseline){
 ...
 */
    private void displayStatus(FacePamphletProfile profile,double imageBaseline){
        GLabel status;
 ...
 */
    private void displayFriends(FacePamphletProfile profile,double nameBaseline){
        int friendCounter=0;
