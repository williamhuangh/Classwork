...
void enterWords(BoggleExtension& b);
string setUpAndGetInput(BoggleExtension& b);
void checkInput(BoggleExtension& b, string input);
void computerTurn(BoggleExtension& b);
void checkWin(BoggleExtension& b);
...
void playOneGame(Lexicon& dictionary) {
    ...
    BoggleExtension b (dictionary, boardLetters);
    enterWords(b);
    computerTurn(b);
    checkWin(b);
}
